...
- *🛣 Adaptive Routing*: Automatically reroutes when roads are blocked or conditions change
...
2. *Choose your scenario*:
   ...
   - 🛠 *Custom Setup*: Build your own disaster scenario
...
|-----------|---------|-----------|
| *🛣 Routing Engine* | Find optimal paths between locations | A*, Dijkstra, MST |
...
- *🛣 Adaptive Response*: Real-time rerouting in <5 seconds
...
If you found any issues or need to contact us, please reach out to: *luckybhatt005@gmail.com*
